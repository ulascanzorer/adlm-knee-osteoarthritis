...
def train_autoencoder(
    ...
    print(f"This is the size of the dataloader: {len(dataloader)}")
    ...
    for epoch in range(num_epochs):
        ...
        for vol in pbar:
            ...
            vol = 2 * ((vol - vol.min()) / (vol.max() - vol.min() + 1e-8)) - 1  # TODO: Check if this makes sense, the goal is to normalize the values to the range of [-1, 1].
